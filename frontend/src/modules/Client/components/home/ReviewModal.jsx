      ...
      <div className="bg-white dark:bg-app-card rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-200 dark:border-white/10 relative">
        ...
        <div className="p-6 md:p-8">
          ...
          <p className="text-sm text-slate-600 dark:text-gray-400 mb-6">
            Share your experience with PLE. Your review will be published after approval.
          </p>
          ...
          {isSuccess ? (
            <div className="text-center py-8">
              ...
              <button 
                onClick={handleClose}
                className="mt-6 px-6 py-2 bg-client-primary text-black font-semibold rounded-lg hover:bg-client-primary/90 transition-colors"
              >
                Close
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-slate-50 dark:bg-black/50 border border-slate-200 dark:border-white/10 rounded-lg focus:outline-none focus:border-client-primary dark:text-white"
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="block w-full text-sm text-slate-500 dark:text-gray-400
                      ...
                      file:bg-client-primary/10 file:text-client-primary
                      hover:file:bg-client-primary/20
                      disabled:opacity-50"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-2 bg-slate-50 dark:bg-black/50 border ${wordCount > WORD_LIMIT ? 'border-red-500' : 'border-slate-200 dark:border-white/10'} rounded-lg focus:outline-none focus:border-client-primary dark:text-white resize-none`}
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full flex justify-center items-center gap-2 px-4 py-3 bg-client-primary text-black font-semibold rounded-lg hover:bg-client-primary/90 transition-colors disabled:opacity-70"
                >
