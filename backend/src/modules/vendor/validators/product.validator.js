...
export const createProductSchema = Joi.object({
    ...
    customCategoryName: Joi.string().allow('', null).optional(),
    customParentCategoryId: objectId.allow(null, '').optional(),
    brandId: objectId.allow(null, '').optional(),
    isCustomBrand: Joi.boolean().optional(),
    customBrandName: Joi.string().allow('', null).optional(),
    stockQuantity: Joi.number().integer().min(0).default(0),
    lowStockThreshold: Joi.number().integer().min(0).default(10),
    stock: Joi.string().valid('in_stock', 'low_stock', 'out_of_stock').optional(),
    salesChannel: Joi.string().valid('B2C', 'B2B', 'BOTH').default('B2C'),
    ...
    gstMode: Joi.string().valid('category', 'custom').default('category'),
